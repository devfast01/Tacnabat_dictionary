...
public class LoadDataHelper extends AsyncTask<Void, Integer, Void> {
    ...
    protected Void doInBackground(Void... params) {
        ...
        if (firstRun) {
            ...
            ArrayList<Dictionary> mArrayBiomedical = preLoadRaw(R.raw.biomedical);
            ...
            try {
                ...
                for (Dictionary model : mArrayBiomedical) {
                    mDictionaryHelper.insertTransaction(DataContract.DataEntry.TABLE_BIOMEDICAL, model);
                    progress += progressDiff;
                    publishProgress((int) progress);
                }
