 ...
 */
public class biomedicalFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_biomedical, container, false);
        setHasOptionsMenu(true);
        @SuppressLint({"MissingInflatedId", "LocalSuppress"}) RecyclerView mRecyclerView = rootView.findViewById(R.id.recylerViewbiomedical);
        mDictionaryHelper = new DictionaryHelper(getContext());
        adapter = new DictionaryListAdapter(getContext());
        // -----------------------------------------------------------------------------------------
        mDictionaryHelper.open();
        mArrayDictionary = mDictionaryHelper.getAllData(DataContract.DataEntry.TABLE_BIOMEDICAL);
        ...
        if (searchManager != null) {
            ...
            searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
                ...
                public boolean onQueryTextSubmit(String query) {
                    mDictionaryHelper.open();
                    mArrayDictionary = mDictionaryHelper.getDataByWord(DataContract.DataEntry.TABLE_BIOMEDICAL, query);
                    mDictionaryHelper.close();
                    adapter.addItem(mArrayDictionary);
                    return true;
                }
                ...
                public boolean onQueryTextChange(String newText) {
                    if (newText!=null){
                        mDictionaryHelper.open();
                        mArrayDictionary = mDictionaryHelper.getDataByWord(DataContract.DataEntry.TABLE_BIOMEDICAL, newText);
                        mDictionaryHelper.close();
                        adapter.addItem(mArrayDictionary);
                    } else {
                        mDictionaryHelper.open();
