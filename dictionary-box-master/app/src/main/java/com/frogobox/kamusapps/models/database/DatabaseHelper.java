...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        try {
            ...
            String sql_create_TABLE_BIOMEDICAL = "CREATE TABLE IF NOT EXISTS " + DataEntry.TABLE_BIOMEDICAL + " (" +
                    DataContract.DataEntry._ID + " INTEGER PRIMARY KEY AUTOINCREMENT," +
                    DataEntry.COLUMN_WORD + " TEXT NOT NULL," +
                    DataEntry.COLUMN_DESCRIPTION + " TEXT NOT NULL);";
            ...
            db.execSQL(sql_create_TABLE_BIOMEDICAL);
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        ...
        String sql_drop_table_Biomedical = "DROP TABLE IF EXISTS " + DataEntry.TABLE_BIOMEDICAL;
        db.execSQL(sql_drop_table_in_to_en);
        db.execSQL(sql_drop_table_en_to_in);
        db.execSQL(sql_drop_table_Biomedical);
